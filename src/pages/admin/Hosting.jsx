      ...
      <div className="page-content-card">
        <div className="hosting-header">
          <div>
            ...
            <p>
              Monitor server status, manage deployments, and oversee
        ...
        <div className="hosting-overview">
          <div className="hosting-overview-grid">
            ...
            <div className="hosting-metric-card">
              <h4>Response Time</h4>
              <span className="hosting-metric-value">
                {infrastructureMetrics.responseTime}ms
              </span>
            </div>
            <div className="hosting-metric-card">
              <h4>Error Rate</h4>
              <span className="hosting-metric-value">
                {infrastructureMetrics.errorRate}%
              </span>
            </div>
            <div className="hosting-metric-card">
              <h4>Bandwidth</h4>
              <span className="hosting-metric-value">
                {infrastructureMetrics.bandwidth} GB/s
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="hosting-tabs">
          <button
            className={`hosting-tab ${
              activeTab === "servers" ? "hosting-tab-active" : ""
            }`}
          ...
          <button
            className={`hosting-tab ${
              activeTab === "deployments" ? "hosting-tab-active" : ""
            }`}
          ...
          <button
            className={`hosting-tab ${
              activeTab === "monitoring" ? "hosting-tab-active" : ""
            }`}
          ...
          <button
            className={`hosting-tab ${
              activeTab === "settings" ? "hosting-tab-active" : ""
            }`}
                  ...
                  <div key={server.id} className="hosting-server-card">
                    <div className="hosting-server-header">
                      <div className="hosting-server-info">
                        <span className="hosting-server-icon">
                    ...
                    <div className="hosting-server-metrics">
                      <div className="hosting-resource-item">
                        ...
                        <div className="hosting-resource-bar">
                          <div
                            className={`hosting-resource-fill ${getResourceStatus(
                              server.cpu
                            )}`}
                            style={{ width: `${server.cpu}%` }}
                          ></div>
                        </div>
                        <span className="hosting-resource-value">
                          {server.cpu}%
                        </span>
                      </div>
                    ...
                    <div className="hosting-server-details">
                      ...
                      <p>
                        ...
                        {formatTimestamp(server.lastRestart)}
                      </p>
                    </div>
            ...
            <div className="hosting-monitoring-section">
              <div className="hosting-monitoring-grid">
                <div className="hosting-monitoring-card">
                  ...
                  <p className="hosting-monitoring-trend">
                    ↗ +5.2% from yesterday
                  </p>
                </div>
                ...
                <div className="hosting-monitoring-card">
                  ...
                  <span className="hosting-monitoring-value">
                    {infrastructureMetrics.cacheHitRate}%
                  </span>
                  <p className="hosting-monitoring-trend">
                    ↗ +2.1% from yesterday
                  </p>
                ...
                <div className="hosting-monitoring-card">
                  ...
                  <span className="hosting-monitoring-value">
                    {infrastructureMetrics.databaseConnections}
                  </span>
                ...
                <div className="hosting-monitoring-card">
                  <h4>Queue Length</h4>
                  <span className="hosting-monitoring-value">
                    {infrastructureMetrics.queueLength}
                  </span>
                  <p className="hosting-monitoring-trend">
                    ↘ -8.3% from yesterday
                  </p>
                ...
                <div className="hosting-alerts-list">
                  <div className="hosting-alert hosting-alert-warning">
                    ...
                    <div>
                      ...
                      <p>
                        API Server 1 CPU usage is at 92%. Consider scaling or
                        optimization.
                      </p>
                    </div>
                  </div>
                  <div className="hosting-alert hosting-alert-error">
                    ...
                    <div>
                      ...
                      <p>
                        Cache Server is currently stopped. This may affect
              ...
              <div className="hosting-settings-grid">
                <div className="hosting-setting-group">
                  ...
                  <label className="hosting-toggle-switch">
                    <input
                      ...
                      onChange={(e) =>
                        handleSettingChange("autoDeployment", e.target.checked)
                      }
                    />
                ...
                <div className="hosting-setting-group">
                  ...
                  <label className="hosting-toggle-switch">
                    <input
                      ...
                      onChange={(e) =>
                        handleSettingChange("rollbackEnabled", e.target.checked)
                      }
                    />
                    <span className="hosting-toggle-slider"></span>
                  </label>
                ...
                <div className="hosting-setting-group">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleSettingChange("deploymentBranch", e.target.value)
                    }
                ...
                <div className="hosting-setting-group hosting-setting-full-width">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleSettingChange("healthCheckUrl", e.target.value)
                    }
                ...
                <div className="hosting-setting-group hosting-setting-full-width">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleSettingChange("buildCommand", e.target.value)
                    }
                    className="hosting-input"
