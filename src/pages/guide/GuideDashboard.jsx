  ...
  const getFilteredTours = (status) => {
    ...
    if (tourFilters.participants !== "all") {
      switch (tourFilters.participants) {
        ...
        case "medium":
          filtered = filtered.filter(
            (tour) => tour.participants > 3 && tour.participants <= 6
          );
          break;
        case "high":
            ...
            <div className="tours-section">
                ...
                <div className="filter-row">
                  <div className="filter-group">
                    <input
                      ...
                      onChange={(e) =>
                        handleTourFilterChange("search", e.target.value)
                      }
                  ...
                  <div className="filter-group">
                    <select
                      ...
                      onChange={(e) =>
                        handleTourFilterChange("location", e.target.value)
                      }
                  ...
                  <div className="filter-group">
                    <select
                      ...
                      onChange={(e) =>
                        handleTourFilterChange("priceRange", e.target.value)
                      }
                      className="filter-select"
                    >
                  ...
                  <div className="filter-group">
                    <select
                      ...
                      onChange={(e) =>
                        handleTourFilterChange("participants", e.target.value)
                      }
                      className="filter-select"
                    >
              ...
              {activeTourTab === "upcoming" && (
                <div className="tour-category">
                  ...
                  <div className="tours-grid">
                    {getPaginatedTours(getFilteredTours("Upcoming")).map(
                      (tour) => (
                        <div key={tour.id} className="tour-card">
                          <div className="tour-header">
                            <h3>{tour.title}</h3>
                            <span
                              className={`tour-status ${tour.status
                                .toLowerCase()
                                .replace(" ", "-")}`}
                            >
                              {tour.status}
                          ...
                          <div className="tour-details">
                            ...
                            <p className="tour-price">
                              <span className="icon-money"></span> {tour.price}
                            </p>
                  ...
                  {getTotalPages(getFilteredTours("Upcoming")) > 1 && (
                    <div className="pagination">
                      ...
                      <div className="pagination-numbers">
                        {Array.from(
                          {
                            length: getTotalPages(getFilteredTours("Upcoming")),
                          },
                          (_, i) => (
                            <button
                              key={i + 1}
                      ...
                      <button
                        ...
                        disabled={
                          currentPage ===
                          getTotalPages(getFilteredTours("Upcoming"))
                        }
                      >
                        Next
                      </button>
              ...
              {activeTourTab === "ongoing" && (
                <div className="tour-category">
                  ...
                  <div className="tours-grid">
                    {getPaginatedTours(getFilteredTours("Ongoing")).map(
                      (tour) => (
                  ...
                  {getTotalPages(getFilteredTours("Ongoing")) > 1 && (
                    <div className="pagination">
                      ...
                      <div className="pagination-numbers">
                        {Array.from(
                          {
                            length: getTotalPages(getFilteredTours("Ongoing")),
                          },
                          (_, i) => (
                            <button
                              key={i + 1}
                      ...
                      <button
                        ...
                        disabled={
                          currentPage ===
                          getTotalPages(getFilteredTours("Ongoing"))
                        }
                      >
                        Next
                      </button>
              ...
              {activeTourTab === "past" && (
                <div className="tour-category">
                  ...
                  <div className="tours-grid">
                    {getPaginatedTours(getFilteredTours("Completed")).map(
                      (tour) => (
                  ...
                  {getTotalPages(getFilteredTours("Completed")) > 1 && (
                    <div className="pagination">
                      ...
                      <button
                        ...
                        disabled={
                          currentPage ===
                          getTotalPages(getFilteredTours("Completed"))
                        }
                      >
                        Next
                      </button>
                ...
                {mockTourRequests.map((request) => (
                  <div key={request.id} className="request-card">
                    <div className="request-header">
                      <div className="tourist-info">
                        ...
                        <div>
                          ...
                          <p className="request-tour-title">
                            {request.tourTitle}
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="request-details">
                      ...
                      <p>
                        <strong>Participants:</strong> {request.participants}
                      </p>
                      <p>
            ...
            <div className="chat-window">
              <div className="chat-messages">
                ...
                <div className="message guide-message">
                  <p>
                    Hello! Yes, I'm excited too. We'll meet at the entrance at
                    8:00 AM.
                  </p>
